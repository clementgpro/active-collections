...
public class SequenceTest {
	...
	public SequenceTest() {
		this.a = new Sequence<Personne>(new ArrayList<Personne>() {
			{
		...
		this.b = new Sequence<Personne>(new ArrayList<Personne>() {
			{
				add(new Personne(18, "Clement", 1));
				add(new Personne(22, "Benjamin", 2));
		...
		this.d = new Sequence<Personne>(new ArrayList<Personne>() {
			{
